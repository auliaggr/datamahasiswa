...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                <img src="{{ asset('img/logo.png') }}" class="fw-bold" alt="" width="30" height="30"> IPB
                UNIVERSITY
            </a>
    ...
    <div class="container" style="position: relative; width: 100%; height: 100vh; overflow: hidden;">
        {{-- <div class="row">
        ...
        <iframe class="py-5" src="http://localhost:3000/public/dashboard/43796df7-0a16-4412-8cc1-8c39df06e282"
