...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link fw-bold active" aria-current="page" href="{{ route('prodi.index') }}">Program Studi</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <div class="text-center">
            <h2 class="my-5 text-center">DAFTAR PROGRAM STUDI DI IPB UNIVERSITY</h2>
            <a href="/prodi/create" class="btn btn-dark">Tambah Data</a>
        </div>
